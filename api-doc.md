...
<https://tokkea.exchangewsspublic.docs.apiary.io/>

# Rest API for Tokkea.Exchange


## API Information

* Base URL for requests is <https://api.tokkea.exchange.io>
...
```
curl --location --request GET "http://api.tokkea.exchange.io/api/v2/public/markets"
...
```
curl --location --request GET "http://api.tokkea.exchange.io/api/v2/public/market?market=ETH_BTC"
...
```
curl --location --request GET "http://api.tokkea.exchange.io/api/v2/public/tickers"
...
```
curl --location --request GET "http://api.tokkea.exchange.io/api/v2/public/ticker?market=ETH_BTC"
...
```
curl --location --request GET "https://api.tokkea.exchange.io/api/v2/public/book?market=ETH_BTC&side=sell&offset=0&limit=100"
...
```
curl --location --request GET "https://api.tokkea.exchange.io/api/v2/public/history?market=ETH_BTC&lastId=1&limit=100"
...
```
curl --location --request GET "https://api.tokkea.exchange.io/api/v2/public/depth/result?market=ETH_BTC&limit=100"
...
```
curl --location --request GET "http://api.tokkea.exchange.io/api/v2/public/market/kline?market=ETH_BTC&interval=1m&offset=0&limit=100"
```
...
* Activate 2FA in your Tokkea exchange account in Account>Security <https://tokkea.exchange.io/settings/security>
* Generate API key and secret in Account>API <https://tokkea.exchange.io/settings/api>
...
X-TXC-APIKEY | {{apiKey}} | YES | Account 'API key' from <https://tokkea.exchange.io/settings/api>
X-TXC-PAYLOAD | {{payload}} | YES |  Body json encoded in base64
X-TXC-SIGNATURE | {{signature}} | YES |  'Payload'  encrypted using HMAC with SHA512 algorithm and 'API secret' from <https://tokkea.exchange.io/settings/api>
...
```
curl --location --request POST "https://api.tokkea.exchange.io/api/v2/account/balances"
...
```
curl --location --request POST "https://api.tokkea.exchange.io/api/v2/account/balance"
  --header "Content-Type: application/json" \
  --header "X-TXC-APIKEY: {{apiKey}}" \
  --header "X-TXC-PAYLOAD: {{payload}}" \
  --header "X-TXC-SIGNATURE: {{signature}}" \
...
```
curl --location --request POST "https://api.tokkea.exchange.io/api/v2/account/order_history"
  --header "Content-Type: application/json" \
  --header "X-TXC-APIKEY: {{apiKey}}" \
  --header "X-TXC-PAYLOAD: {{payload}}" \
  --header "X-TXC-SIGNATURE: {{signature}}" \
...
```
curl --location --request POST "https://api.tokkea.exchange.io/api/v2/account/order"
  --header "Content-Type: application/json" \
  --header "X-TXC-APIKEY: {{apiKey}}" \
  --header "X-TXC-PAYLOAD: {{payload}}" \
  --header "X-TXC-SIGNATURE: {{signature}}" \
...
```
curl --location --request POST "https://api.tokkea.exchange.io/api/v2/account/executed_history"
  --header "Content-Type: application/json" \
  --header "X-TXC-APIKEY: {{apiKey}}" \
  --header "X-TXC-PAYLOAD: {{payload}}" \
  --header "X-TXC-SIGNATURE: {{signature}}" \
...
```
curl --location --request POST "https://api.tokkea.exchange.io/api/v2/account/executed_history/all"
  --header "Content-Type: application/json" \
  --header "X-TXC-APIKEY: {{apiKey}}" \
  --header "X-TXC-PAYLOAD: {{payload}}" \
  --header "X-TXC-SIGNATURE: {{signature}}" \
...
```
curl --location --request POST "https://api.tokkea.exchange.io/api/v2/orders"
  --header "Content-Type: application/json" \
  --header "X-TXC-APIKEY: {{apiKey}}" \
  --header "X-TXC-PAYLOAD: {{payload}}" \
  --header "X-TXC-SIGNATURE: {{signature}}" \
...
```
curl --location --request POST "https://api.tokkea.exchange.io/api/v2/order/new"
  --header "Content-Type: application/json" \
  --header "X-TXC-APIKEY: {{apiKey}}" \
  --header "X-TXC-PAYLOAD: {{payload}}" \
  --header "X-TXC-SIGNATURE: {{signature}}" \
...
```
curl --location --request POST "https://api.tokkea.exchange.io/api/v2/order/cancel"
  --header "Content-Type: application/json" \
  --header "X-TXC-APIKEY: {{apiKey}}" \
  --header "X-TXC-PAYLOAD: {{payload}}" \
  --header "X-TXC-SIGNATURE: {{signature}}" \
...
```
curl --location --request POST "https://api.е.io//api/v2/order/cancel/all"
  --header "Content-Type: application/json" \
  --header "X-TXC-APIKEY: {{apiKey}}" \
  --header "X-TXC-PAYLOAD: {{payload}}" \
  --header "X-TXC-SIGNATURE: {{signature}}" \
